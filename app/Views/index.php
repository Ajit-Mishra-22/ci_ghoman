...
<div class="services-cards-wrap" id="services">
  ...
  <div class="services-grid">
    <div class="svc-card not-revealed" data-reveal="up" data-delay="100">
      <div class="svc-icon-wrap">
        <svg viewBox="0 0 48 48">
          ...
          <line x1="8" y1="16" x2="14" y2="20" />
          <line x1="40" y1="16" x2="34" y2="20" />
        </svg>
      </div>
    ...
    <div class="svc-card not-revealed" data-reveal="up" data-delay="300">
      <div class="svc-icon-wrap">
        <svg viewBox="0 0 48 48">
          <polyline points="8,36 18,24 26,30 36,16 42,22" />
    ...
    <div class="svc-card not-revealed" data-reveal="up" data-delay="100">
      <div class="svc-icon-wrap">
        <svg viewBox="0 0 48 48">
          <path d="M24 6 L30 18 L44 18 L33 27 L37 41 L24 33 L11 41 L15 27 L4 18 L18 18 Z" />
        </svg>
      </div>
    ...
    <div class="svc-card not-revealed" data-reveal="up" data-delay="200">
      <div class="svc-icon-wrap">
        <svg viewBox="0 0 48 48">
          ...
          <rect x="19" y="20" width="10" height="22" rx="2" />
          <rect x="32" y="12" width="10" height="30" rx="2" />
    ...
    <div class="svc-card not-revealed" data-reveal="up" data-delay="300">
      <div class="svc-icon-wrap">
        <svg viewBox="0 0 48 48">
          <path d="M24 6 C14 6 8 12 8 20 C8 28 14 32 24 34 C34 32 40 28 40 20 C40 12 34 6 24 6Z" />
          <path d="M16 20 L20 24 L28 16" stroke-width="2.5" fill="none" />
  ...
  <div class="about-grid">
    ...
    <div class="about-content" data-reveal="left">
      ...
      <div class="feature-pills">
        ...
        <div class="pill">
          <div class="pill-dot"></div>Cloud-Ready
        </div>
        <div class="pill">
          <div class="pill-dot"></div>ISO 27001
        </div>
        <div class="pill">
          <div class="pill-dot"></div>SOC 2 Type II
        </div>
        <div class="pill">
          <div class="pill-dot"></div>24/7 Support
        </div>
      </div>
    ...
    <div class="wcu-center">
      ...
      <div class="wcu-icon-pair" data-reveal="zoom" data-delay="300">
        ...
        <div class="wcu-icon icon-teal">
          <svg viewBox="0 0 32 32">
            <path d="M16 4 L28 10 L28 18 C28 23 22 27 16 29 C10 27 4 23 4 18 L4 10 Z" />
            <polyline points="10,16 14,20 22,12" stroke-width="2.5" />
          </svg>
        </div>
      </div>
